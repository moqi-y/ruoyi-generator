...
public class GenConstants
{
     ...
     * 模板类型-前端-HTML
     */
    public static final String TPL_FRONT_HTML = "html";

    /**
     * 模板类型-前端-VUE2
     */
    public static final String TPL_FRONT_VUE2 = "vue2";

    /**
     * 模板类型-前端-VUE3
     */
    public static final String TPL_FRONT_VUE3 = "vue3";
    ...
    public static final String[] COLUMNTYPE_NUMBER = {"tinyint", "smallint", "mediumint", "int", "int2",
                                                      "int4", "int8", "number", "integer", "bigint", "float",
                                                      "float",
                                                      "double", "decimal"};
