...
public class DataSourceComposeUtils
{
     ...
     * MySQL连接字符串模板
     */
    private static String URL_TEMPLATE_MYSQL =
            "jdbc:mysql://{}:{}/{}?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8";
    /**
     * Oracle的SID连接字符串模板
     */
