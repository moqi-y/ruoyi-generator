/*
 ...
 Date: 09/03/2023 10:24:12
*/

PRAGMA foreign_keys = false;

-- ----------------------------
-- Table structure for _gen_table_old_20230309
-- ----------------------------
DROP TABLE IF EXISTS "_gen_table_old_20230309";
CREATE TABLE "_gen_table_old_20230309" (
...
-- ----------------------------
-- Records of _gen_table_old_20230309
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE "gen_table" (
  ...
  "class_name" VARCHAR(100) DEFAULT '',
  "tpl_category" VARCHAR(200) DEFAULT 'crud',
  "tpl_frontend" VARCHAR(200) DEFAULT 'html',
  "package_name" VARCHAR(100),
  "module_name" VARCHAR(30),
  "business_name" VARCHAR(30),
  "function_name" VARCHAR(50),
...
INSERT INTO "sqlite_sequence" ("name", "seq") VALUES ('sys_data_source', 2);
INSERT INTO "sqlite_sequence" ("name", "seq") VALUES ('gen_table_column', 1);
INSERT INTO "sqlite_sequence" ("name", "seq") VALUES ('sys_config', 1);
INSERT INTO "sqlite_sequence" ("name", "seq") VALUES ('_gen_table_old_20230309', 1);
...
-- ----------------------------
BEGIN;
INSERT INTO "sys_data_source" ("id", "name", "db_type", "oracle_conn_mode", "service_name_or_sid", "host", "port", "username", "password", "schema_name", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (2, 'ebr_platform_dev', 'mysql', 'service_name', NULL, 'localhost', 3318, 'root', 'root', 'public', '0', '', '2023-03-09 10:22:25', '', NULL, 'localhot_MySQL_8.0');
COMMIT;
...
-- ----------------------------
-- Auto increment value for _gen_table_old_20230309
-- ----------------------------
UPDATE "main"."sqlite_sequence" SET seq = 1 WHERE name = '_gen_table_old_20230309';
...
-- ----------------------------
UPDATE "main"."sqlite_sequence" SET seq = 2 WHERE name = 'sys_data_source';
